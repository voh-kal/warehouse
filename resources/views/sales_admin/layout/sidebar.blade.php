				...
				<ul class="nav nav-primary">
					...
					<li class="nav-item">
						...
						<div class="collapse" id="base">
							<ul class="nav nav-collapse">
								<li>
									<a href="/sales-admin/create-warehouse">
										<span class="sub-item">Create Warehouse</span>
									</a>
								</li>
								<li>
									<a href="/sales-admin/all-warehouse">
										<span class="sub-item">All Warehouses</span>
									</a>
								</li>
					...
					<li class="nav-item">
						...
						<div class="collapse" id="sidebarLayouts">
							<ul class="nav nav-collapse">
								<li>
									<a href="/sales-admin/add-product">
										<span class="sub-item">Add Product</span>
									</a>
								</li>
								<li>
									<a href="/sales-admin/create-product">
										<span class="sub-item">Create Product</span>
									</a>
								</li>
								<li>
									<a href="/sales-admin/available-product">
										<span class="sub-item">Available Product</span>
									</a>
								</li>
